...
public:
    ...
    void escalar_to_ecolor( char* property="e:quality"){
        ...
        Surface_mesh::Edge_property<Color>  ecolor   = mesh->edge_property<Color>("e:color",Color(0));
    ...
    void vscalar_to_vcolor(const string property="v:quality"){
        ...
        Surface_mesh::Vertex_property<Color>  vcolor   = mesh->vertex_property<Color>("v:color",Color(0));
        ...
        foreach(Vertex v, mesh->vertices()){
            ...
            if(isnan(val)) qDebug() << "Warning: colorizing 'nan' value";
            if(isinf(val)) qDebug() << "Warning: colorizing 'inf' value";
