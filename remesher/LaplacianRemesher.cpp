...
void LaplacianRemesher::initParameters(SurfaceMeshModel* mesh, RichParameterSet* parameters, StarlabDrawArea *){
    ...
    mesh->renderer()->setRenderMode("Flat Wire");
}

void LaplacianRemesher::applyFilter(SurfaceMeshModel *model, RichParameterSet* pars, StarlabDrawArea * /*drawArea*/){
    SurfaceMeshModel* mesh = qobject_cast<SurfaceMeshModel*>(model);
    if(!mesh) throw StarlabException("NOT A SURFACEMESH!");    
