...
class PoleAttractorHelper : public MeanValueLaplacianHelper{

private:
	SparseMatrix<double> L;
	
public:
	PoleAttractorHelper(SurfaceMeshModel* mesh) : SurfaceMeshHelper(mesh), LaplacianHelper(mesh), MeanValueLaplacianHelper(mesh){}
	...
	void solve(ScalarVertexProperty omega_H, ScalarVertexProperty omega_L, 
		ScalarVertexProperty omega_P, Vector3VertexProperty poles)
	{
